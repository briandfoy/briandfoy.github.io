...
Perl 5 had lost its leader, even if he had been a reluctant one. It also lost it's way. Perl development had two Rules that kept the peace and laid to rest contentious decisions:
...
Maybe I was too optimistic last year. Some Perl maintainers led a coup that deposed Sawyer X and installed a committee in his place. That's the best tactic to prevent change and progress. As Nicholas Clark pointed out, this committee has no power because nobody has to obey it either affirmatively or even passively. And no one does obey it because the inmates run the asylum. There's no real leadership when you yourself are deciding what you yourself can do.

Sawyer, as the selected project leader, had had the audacity to break
the Perl market segments into three groups:

* The Absentee - a former Perl user who doesn't directly use it anymore (the no change group)
* The Novice - doesn't care about history
* Marie - the daily user

<iframe width="560" height="315" src="https://www.youtube.com/embed/6wPMh-3qYJM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

Sawyer's point is that everything in Perl's development process is weighted toward the Absentee, and that's holding back the people actually using Perl. Maybe that should change. Watch the video; it's too complex for summary.

And Perl 5 Porters lost their shit over this.
