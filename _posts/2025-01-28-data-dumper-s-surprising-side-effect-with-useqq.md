...
#
Okay, so now I know that happens. But, I didn't ask for [Data::Dumper](https://perldoc.perl.org/Data::Dumper) to think about numbers and strings. I told it to use double quotes instead of single quotes, but it's decided to use no quotes.
